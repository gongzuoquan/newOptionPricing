							   ...
							   float *const X,float *const Y)
{
	...
	if(tid==0)
	{
		...
		printf("%f %f %f",beta1,beta2,beta3);
	}
	*/
}
int main()
{
	...
	computeWeights<<<grid,block,block.x*sizeof(float),0>>>(d_sumX2s,d_sumX2Squares,d_sumX3s,d_sumX3Squares,d_sumYs,d_sumX2X3s,d_sumX2Ys,d_sumX3Ys,d_uniform_rands,d_normal_rands);
